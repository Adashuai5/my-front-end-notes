[面试完50个人后我写下这篇总结](https://juejin.im/post/5df1e312f265da33d039d06d#heading-74)
...
[【深度长文】JavaScript数组所有API全解密](http://louiszhai.github.io/2017/04/28/array/#splice)
...
5. const array = [1,2] ，向前增加3个数据
6. let obj = {fn:{console.log(this),fn1:()=>{console.log(this)}}
obj.fn() // obj
obj.fn1() // window
const {fn,fn1}=obj
obj.fn() // window
